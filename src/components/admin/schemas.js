...
export const SECTION_SCHEMAS = {
  ...
  products: [
    ...
    i18n('title', 'Título'),
    i18nArea('text', 'Texto', 3),
    num('limit', 'Cantidad de productos a mostrar', { min: 1, max: 12 }),
  ...
  counters: [
    {
      ...
      titleKey: 'label',
      blank: { icon: 'award', value: 0, suffix: '+', label: '' },
      fields: [
...
export const COLLECTIONS = {
  ...
  products: {
    ...
    fields: [
      i18n('title', 'Nombre del producto'),
      text('slug', 'URL (slug)', { hint: 'Solo minúsculas y guiones. Ej: almohada-cervical' }),
      text('price', 'Precio', { hint: 'Texto libre: $49, Desde $49, o Consultar en consulta.' }),
      i18n('category', 'Categoría', { hint: 'Ej: Recuperación, Postura, Tópicos' }),
      i18n('badge', 'Etiqueta destacada', { hint: 'Opcional. Ej: Más recomendado, Nuevo, Agotado' }),
      image('image', 'Foto', { hint: 'Cuadrada, recomendado 800×800 px' }),
      i18nArea('excerpt', 'Resumen corto', 3),
      i18nArea('body', 'Descripción completa', 8, { hint: 'Deje una línea en blanco entre párrafos.' }),
    ],
  },
  team: {
    label: 'Equipo',
  ...
  testimonials: {
    label: 'Testimonios',
    titleKey: 'name',
    blank: { name: 'Nuevo paciente', role: '', rating: 5, image: '', text: '' },
    fields: [
...
export const PAGE_EXTRA_SCHEMAS = {
  ...
  products: { intro: [{ key: '__self', label: 'Texto introductorio', type: 'i18nArea', rows: 4 }] },
